package com.urbanisationsi.springdata12.service;

import com.urbanisationsi.springdata12.PersonneRepository;
import com.urbanisationsi.springdata12.dao.AssureRepository;
import com.urbanisationsi.springdata12.dao.ConseillerBancaireRepository;
import com.urbanisationsi.springdata12.modele.Assure;
...
public class AssureService implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        personne.setNumeroPersonne(3222L);
        personne.setDateNaissance(LocalDate.of(1975, Month.JANUARY, 15));
        personneRepository.save(personne);
        log.info("Personne sauvegardée : {}", personne);
